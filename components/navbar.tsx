...
>
  {isOpen && (
    <div className="absolute inset-0 top-16 bg-background/20 backdrop-blur-xl flex justify-end">
      <div className="mobile-menu-container w-full sm:w-2/3 md:w-1/2 h-[calc(100vh-4rem)] bg-background/100 backdrop-blur-2xl p-6 shadow-lg flex flex-col space-y-6 items-center overflow-y-auto">
        {navLinks.map((link, index) => (
          <motion.div
            key={link.name}
            initial={{ opacity: 0, y: 20 }}
